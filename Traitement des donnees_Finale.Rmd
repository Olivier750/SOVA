...
DONNEE_CIRCULATION<-read.csv2(file.choose(), header=TRUE, sep=";") # Lire le fichier DONNEE_CIRCULATION.csv
...
```{r}
TAB_bis<-TAB2[,c(1:4,6,7,10,11,13,14,15,16,17,19,20,"ANNEE_POSE","TR_ANNEE_POSE")]
```
...
```{r}
TAB_bisL$TR_ANNEE_POSE<-factor(TAB_bis$TR_ANNEE_POSE)
...
TAB_bis$VITESSE_bis[TAB_bis$VITESSE_bis=="(-10,50]"]<-"[50,10]"
